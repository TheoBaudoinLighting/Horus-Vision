...
HorusRadeon& radeon_ImMat = HorusRadeon::get_instance();
...
{
	RPRGarbageCollector m_gc = radeon_ImMat.get_gc();
...
rpr_material_node HorusMaterial::create_material()
{
	...
	CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_UBERV2, &material_node_uberv2));
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_basecolor_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_basecolor_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_roughness_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_roughness_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_normal_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_normal_texture);
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_NORMAL_MAP, &uberMat2_bumpmap));
				radeon_ImMat.get_gc().GCAdd(uberMat2_bumpmap);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_metallic_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_metallic_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_emissive_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_emissive_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_opacity_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_opacity_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_diffuse_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_diffuse_weight_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_reflection_color_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_reflection_color_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_reflection_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_reflection_weight_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_reflection_roughness_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_reflection_roughness_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_refraction_color_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_refraction_color_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_refraction_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_refraction_weight_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_refraction_roughness_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_refraction_roughness_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_coating_color_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_coating_color_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_coating_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_coating_weight_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_coating_roughness_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_coating_roughness_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_sheen_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_sheen_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_sheen_tint_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_sheen_tint_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_emission_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_emission_weight_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_sss_scatter_color_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_sss_scatter_color_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_sss_scatter_distance_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_sss_scatter_distance_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_backscatter_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_backscatter_weight_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_backscatter_color_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_backscatter_color_texture);
		...
		std::thread loadTextureThread([&]()
			{
				...
				CHECK(rprMaterialSystemCreateNode(radeon_ImMat.get_matsys(), RPR_MATERIAL_NODE_IMAGE_TEXTURE, &uberMat2_img_sheen_weight_texture));
				radeon_ImMat.get_gc().GCAdd(uberMat2_img_sheen_weight_texture);
...
rpr_image HorusMaterial::load_texture(std::string path)
{
	...
	if (rprContextCreateImageFromFile(radeon_ImMat.get_context(), path.c_str(), &image) != RPR_SUCCESS)
	{
		spdlog::error("Error: Texture -> {} not found.", path);
		return nullptr;
	}

	radeon_ImMat.get_gc().GCAdd(image);
		...
		std::thread loadTextureThread([&]()
			{
				...
				rpr_status status = rprSceneSetBackgroundImage(g_object_impm.get_scene(), texture_background);

				radeon_ImMat.get_gc().GCAdd(texture_background);
...
{
		rpr_status status = rprSceneSetBackgroundImage(g_object_impm.get_scene(), nullptr);
}
